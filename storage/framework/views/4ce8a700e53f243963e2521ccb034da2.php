                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="" method="POST">
                                        ...
                                        <input type="submit" value="Reset Password" class="btn btn-warning btn-user btn-block" href="<?php echo e(url('/')); ?>">
                                        <hr>
                                    </form>
                                </div>
                            </div>
...
<?php /**PATH C:\Laravel\spp\resources\views/reset.blade.php ENDPATH**/ ?>